                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xxl-6">
                        <div class="text-center my-5">
                            <h1 class="fw-bolder mb-3">Our mission is to bring an alluring experience in the comedy
                                industry.</h1>
                            <p class="lead fw-normal text-muted mb-4">Lorem Ipsum is simply dummy text of the printing
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6"><img class="img-fluid rounded mb-5 mb-lg-0"
                                               src="{{asset('/frontend/assets/picone.jpg')}}" alt="..."/></div>
                    <div class="col-lg-6">
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-first order-lg-last"><img class="img-fluid rounded mb-5 mb-lg-0"
                                                                         src="{{asset('/frontend/assets/pictwo.jpg')}}"
                                                                         alt="..."/></div>
                    <div class="col-lg-6">
