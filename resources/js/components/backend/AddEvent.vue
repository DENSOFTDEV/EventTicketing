                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-white">
                            <h3 class="card-title">Add Events Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <ValidationProvider rules="required" name="Poster"
                                                ...
                                                >
                                                    <div class="row">
                                                        <div v-if="form.poster" class="col-md-4">
                                                            <img
                                                                :src="form.poster"
                                                                class="img-thumbnail"
        ...
        methods: {
            addEvent() {
                ...
                axios.post('/admin/store-event', this.form).then((response) => {
                    ...
                    this.$refs.addEventObserver.setErrors(error.response.data.errors);
                })
            ...
            showPoster(e) {
                ...
                reader.onload = (event) => {
                    this.form.poster = event.target.result;
                }
